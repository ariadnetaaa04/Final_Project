   ...
   // private Vector3 offset;
    ...
    void Update()
    {
       ...
       // transform.position = playerBody.transform.position + offset;
        ...
        float mouseX = Input.GetAxisRaw("Mouse X") * Sensibility * UnityEngine.Time.deltaTime;
        //mouse movement in Y (pixels)
       // float mouseY= Input.GetAxisRaw("Mouse Y") * Sensibility * UnityEngine.Time.deltaTime;
